 ...
 * @license AGPL-3.0
 */
class CRM_Streetimport_Config_CustomGroup {

  protected $_apiParams = array();

  /**
   * CRM_Streetimport_Config_CustomGroup constructor.
   */
  ...
  private function validateCreateParams($params) {
    if (!isset($params['name']) || empty($params['name']) || !isset($params['extends']) ||
      ...
      and can not be empty in class CRM_Streetimport_Config_CustomGroup');
    }
