 ...
 * @license AGPL-3.0
 */
class CRM_Streetimport_Config_ContactType {

  protected $_apiParams = array();

  /**
   * CRM_Streetimport_Config_ContactType constructor.
   */
  ...
  public function create($params) {
    ...
    if (!isset($this->_apiParams['label']) || empty($this->_apiParams['label'])) {
      $this->_apiParams['label'] = CRM_Streetimport_Utils::buildLabelFromName($this->_apiParams['name']);
    }
    try {
